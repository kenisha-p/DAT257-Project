...
const RemoveAlert = ({ visible, onCancel, onConfirm }) => {
  const handleConfirm = () => {
    console.log('Ja-knappen klickades på');
    onConfirm();
  };
    ...
    <Modal visible={visible} transparent>
      <View style={styles.modalBackground}>
        <View style={styles.modalContainer}>
          <Text style={styles.title}>Confirm removal</Text>
          <Text style={styles.subtitle}>Are you sure you want to remove the selected times?</Text>
